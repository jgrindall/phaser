...
define(['app/game', 'app/components/buttongrid', 'app/components/buttons/levelbadge'],

function(Game, ButtonGrid, LevelBadge){
	...
	LevelDataProvider.prototype.addPage = function(i, numX, numY, scroller){
		...
		options = {"bounds":bounds, "numX": numX, "numY": numY, "buttonClass": LevelBadge};
